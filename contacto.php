...
<meta name="description" content="Firma de Abogados Laborales, fundada por el Lic. Octavio Carvajal Bustamante." />
<meta name="keywords" content="Abogados laborales, Octavio Carvajal Bustamante, asesoría jurídica, sector empresarial, Derecho de Trabajo, Seguridad Social, México, D.F." />
<link href="../css/cbt.css" rel="stylesheet" type="text/css">
        
<title>CBT Abogados laborales</title>
<style>
	@media only screen 
    	...
    	<div class="header">
        	<div class="redes"> <a href="https://www.facebook.com/pages/CBT-Abogados/1422439021342910?ref=ts&fref=ts" target="_blank" class="fb" title="Facebook"><img src="../img/icons/facebook_icon.png" /></a>
             ...
             <div class="cont_int">
                ...
                <div class="adress_int">GOETHE No. 16, 4o Piso<br/> Colonia Anzures  C.P. 11590<br/> Tel:. 5254 - 4970 / al 72 <br />fax: 5254-4976<br /> e-mail:<a href="mailto:cbt@cbtasesores.com.mx">cbt@cbtasesores.com.mx</a> </div>
             </div><!--cont_int-->
             <div id="menu">
             	<ul>
...
<li><a href="clientes.html" class="">CLIENTES</a></li>
            ...
            <div id="cont_info">
                ...
                <p class="intro" style="color:#093769;font-size:17px;">Agradecemos su interés en nuestra firma y en los servicios que ofrecemos, si desea contactarnos, ingrese los datos que se le solicitan y en breve un ejecutivo se pondrá en contacto con usted para darle la atención personalizada a sus necesidades.</p>
                <div class="cont_full">
    ...
    <div id="footer">
    	<span>CBT Abogados Laborales | Todos los derechos reservados 2019</span>
    </div><!--footer-->
</div><!--wrapper_gral-->
...
<script type="text/javascript" src="../js/jquery-1.11.1.js"></script>
<script type="text/javascript" src="../js/functions.js"></script>
<script type="text/javascript" src="../js/functions_mob.js"></script>
</body>
</html>
